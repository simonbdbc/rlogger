# Compatibilité — logger 0.2.0 / compagnon 0.3.0 / lecteur 0.5.0
...
| Compagnon / frontend | local-logs-server 0.3.0, local-logs-viewer 0.5.0 |
...
Le frontend 0.5.0 utilise le compagnon 0.3.0 ;
les anciennes routes de lecture restent disponibles, mais un ancien compagnon
ne fournit pas les nouvelles métadonnées au frontend 0.5.0.
